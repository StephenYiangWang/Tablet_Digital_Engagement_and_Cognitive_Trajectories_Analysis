...
write.csv(
  friedman_df,
  file = "~/Downloads/supplementary_table_2_friedman_result.csv",
  row.names = FALSE
)
...
write.csv(
  nemenyi_pvalues,
  file = "~/Downloads/supplementary_table_2_nemenyi_pvalues.csv",
  row.names = TRUE
)

write.csv(
  nemenyi_statistics,
  file = "~/Downloads/supplementary_table_2_nemenyi_statistics.csv",
  row.names = TRUE
)
