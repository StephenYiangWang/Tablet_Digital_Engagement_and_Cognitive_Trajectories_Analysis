...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_13_abs_monthly_frequency_all_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_13_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_13_abs_monthly_frequency_all_apps.csv",
  row.names = FALSE
)
