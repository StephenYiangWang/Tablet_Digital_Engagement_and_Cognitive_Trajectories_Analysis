...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_06_abs_monthly_duration_all_apps_class3_vs_class4_month_"

dir.create(
  "~/Downloads/supplementary_table_6_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_6_abs_monthly_duration_all_apps_class3_vs_class4.csv",
  row.names = FALSE
)
