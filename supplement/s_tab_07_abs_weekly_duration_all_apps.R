...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_07_abs_weekly_duration_all_apps_week_"

dir.create(
  "~/Downloads/supplementary_table_7_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_7_abs_weekly_duration_all_apps.csv",
  row.names = FALSE
)
