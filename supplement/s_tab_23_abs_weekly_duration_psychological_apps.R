...
catVars <- c("Class")
file_prefix <- "s_tab_23_abs_weekly_duration_psychological_apps_week_"

dir.create(
  "~/Downloads/supplementary_table_23_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_23_abs_weekly_duration_psychological_apps.csv",
  row.names = FALSE
)
