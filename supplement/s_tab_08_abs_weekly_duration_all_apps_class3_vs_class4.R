...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_08_abs_weekly_duration_all_apps_class3_vs_class4_week_"

dir.create(
  "~/Downloads/supplementary_table_8_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_8_abs_weekly_duration_all_apps_class3_vs_class4.csv",
  row.names = FALSE
)
