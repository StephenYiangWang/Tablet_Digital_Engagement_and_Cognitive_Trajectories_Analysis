...
catVars <- c("Class")
file_prefix <- "s_tab_25_cum_monthly_duration_psychological_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_25_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_25_cum_monthly_duration_psychological_apps.csv",
  row.names = FALSE
)
