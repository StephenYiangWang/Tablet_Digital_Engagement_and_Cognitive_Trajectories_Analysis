...
catVars <- c("Class")
file_prefix <- "s_tab_27_cum_weekly_duration_psychological_apps_week_"

dir.create(
  "~/Downloads/supplementary_table_27_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_27_cum_weekly_duration_psychological_apps.csv",
  row.names = FALSE
)
