...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_11_cum_weekly_duration_all_apps_week_"

dir.create(
  "~/Downloads/supplementary_table_11_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_11_cum_weekly_duration_all_apps.csv",
  row.names = FALSE
)
