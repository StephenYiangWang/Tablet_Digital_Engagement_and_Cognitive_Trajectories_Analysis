...
catVars <- c("Class")
file_prefix <- "s_tab_39_cum_monthly_duration_cognitive_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_39_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_39_cum_monthly_duration_cognitive_apps.csv",
  row.names = FALSE
)
