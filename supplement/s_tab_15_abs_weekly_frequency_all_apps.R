...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_15_abs_weekly_frequency_all_apps_week_"

dir.create(
  "~/Downloads/supplementary_table_15_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_15_abs_weekly_frequency_all_apps.csv",
  row.names = FALSE
)
